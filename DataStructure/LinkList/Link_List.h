...
void CreateLinkList(struct LinkList **L, int L_size, datatype init_value, bool random_value){
...
void InsertLinkNode(struct LinkList **L, int target_idx, datatype target_value){
